    ...
    <nav id="menu">
        <div className="inner">
            ...
            <ul className="actions vertical">
                < li > < a href = "https://www.dropbox.com/s/ky1ukdten398zc6/Jacob-Amador-Resume.pdf?dl=0" target = "__blank" onClick={props.onToggleMenu} className ="button special fit" >Resume</a></li >
            </ul>
        </div>
